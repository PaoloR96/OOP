...
public class FriendRequestSend extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				listaRichieste=cr.ListRequestSend(IdUserLoggato);
				request.setAttribute("dataReq", listaRichieste);
				RequestDispatcher rd = request.getRequestDispatcher("ListRequestFriendSend.jsp");
